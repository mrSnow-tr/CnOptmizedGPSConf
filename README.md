...
0. [Download](https://github.com/mrSnow-tr/CnOptmizedGPSConf/releases/latest/download/OptmizedGPSConf.zip)
...
#### Version 1.0
- Use gps.conf from HyperOS 1
- Update README.md
- Add [release package](https://github.com/mrSnow-tr/CnOptmizedGPSConf/releases/latest/download/OptmizedGPSConf.zip)

## Reference
- https://github.com/skyrocketingHong/
