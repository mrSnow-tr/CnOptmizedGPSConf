...
## Requirements
- A device with Qualcomm Snapdragon or Mediatek chipset based.
...
0. [Download](https://github.com/mrSnow-tr/UniversalOptmizedGPSConf/releases/latest/download/UniversalOptmizedGPSConf.zip)
1. Go to Magisk Manager **_Modules_** section.
2. Click on **_+_** yellow button and search/find for this **_"universaloptimizedgpsconf.zip"_** file and long press on it.
